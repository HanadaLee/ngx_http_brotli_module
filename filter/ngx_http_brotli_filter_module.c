...
static ngx_command_t ngx_http_brotli_filter_commands[] = {
    ...
    { ngx_string("brotli_max_length"),
      ...
      ngx_conf_set_size_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_brotli_conf_t, max_length),
      NULL },
    ...
    { ngx_string("brotli_bypass"),
      ...
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_brotli_conf_t, bypass),
      NULL },
...
static char *
ngx_http_brotli_merge_conf(ngx_conf_t *cf, void *parent,
    void *child)
{
